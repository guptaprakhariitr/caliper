...
Thanks for your interest! Caliper is the open-source **shell** of a macOS pixel ruler, loupe and color picker. The UI, view model and app plumbing live here under the MIT license; the edge-detection/snapping **engine** is a separate proprietary module shipped as a binary in public releases (it builds from source in this private repo).
...
`~/Library/Containers/com.plainware.caliper/Data/Library/Logs/Plainware/Caliper.log`.
